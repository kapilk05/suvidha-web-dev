export default function AboutBody(){
    return(
        <div>
            <div className="bg-white text-center  text-justify break-all  p-10 xl:p-52 xl:text-left">
                <div className="flex flex-wrap space-y-12 xl:space-x-20 xl:space-y-0">
                    <h2 className="text-blue-400 text-2xl  font-medium xl:text-4xl  xl:flex-1">
                    Empowered youth can lift their entire families and communities out of poverty.
                    </h2>
                    <h3 className="text-lg justify-center text-gray-500 xl:flex-1 xl:text-lg" >
